...
export declare const EXECUTION_TOKEN_EXPIRY_SECONDS = 30;
/**
...
export declare function isExecutionTokenPayload(value: unknown): value is ExecutionTokenPayload;
/**
 * Token süresi dolmuş mu?
 * true → EXPIRED_TOKEN → DENY + LOG (TOCTOU koruması)
 */
export declare function isTokenExpired(payload: ExecutionTokenPayload, nowSeconds?: number): boolean;
/**
 * Token scope'u Decision ile eşleşiyor mu?
 * Format kontrolü: "{category}:{action_name}"
 */
export declare function isScopeValid(payload: ExecutionTokenPayload, category: string, actionName: string): boolean;
/**
 * expires_at tutarlılığını kontrol eder.
 * expires_at === issued_at + 30 olmalı.
 */
export declare function isExpiryConsistent(payload: ExecutionTokenPayload): boolean;
//# sourceMappingURL=execution-token.d.ts.map