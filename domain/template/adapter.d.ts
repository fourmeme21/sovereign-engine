...
export interface DomainAdapter {
     ...
     */
    execute(actionName: string, params: unknown, context: ExecutionContext): Promise<ActionResult>;
    /**
 ...
 */
export declare function runBaseContractChecks(adapter: DomainAdapter): Promise<boolean>;
