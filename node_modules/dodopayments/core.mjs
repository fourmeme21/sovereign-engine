...
import { DodoPaymentsError, APIError, APIConnectionError, APIConnectionTimeoutError, APIUserAbortError, } from "./error.mjs";
...
export const toBase64 = (str) => {
    ...
    throw new DodoPaymentsError('Cannot generate b64 string; Expected `Buffer` or `btoa` to be defined');
};
