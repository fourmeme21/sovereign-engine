...
import { CustomerWallet, WalletListResponse, Wallets } from "./wallets/wallets.js";
...
export declare class Customers extends APIResource {
    ...
    update(customerId: string, body: CustomerUpdateParams, options?: Core.RequestOptions): Core.APIPromise<Customer>;
