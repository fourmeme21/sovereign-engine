...
export declare class Licenses extends APIResource {
     ...
     * ```
     */
    activate(body: LicenseActivateParams, options?: Core.RequestOptions): Core.APIPromise<LicenseActivateResponse>;
    /**
     * @example
     * ```ts
     ...
     * ```
     */
    validate(body: LicenseValidateParams, options?: Core.RequestOptions): Core.APIPromise<LicenseValidateResponse>;
}
