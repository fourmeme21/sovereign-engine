...
export declare class Meters extends APIResource {
    ...
    list(query?: MeterListParams, options?: Core.RequestOptions): Core.PagePromise<MetersDefaultPageNumberPagination, Meter>;
...
export declare class MetersDefaultPageNumberPagination extends DefaultPageNumberPagination<Meter> {
}
...
export declare namespace Meters {
    export { type Meter as Meter, type MeterAggregation as MeterAggregation, type MeterFilter as MeterFilter, MetersDefaultPageNumberPagination as MetersDefaultPageNumberPagination, type MeterCreateParams as MeterCreateParams, type MeterListParams as MeterListParams, };
}
