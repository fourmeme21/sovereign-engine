...
export declare class Payments extends APIResource {
    ...
    list(query?: PaymentListParams, options?: Core.RequestOptions): Core.PagePromise<PaymentListResponsesDefaultPageNumberPagination, PaymentListResponse>;
    list(options?: Core.RequestOptions): Core.PagePromise<PaymentListResponsesDefaultPageNumberPagination, PaymentListResponse>;
    retrieveLineItems(paymentId: string, options?: Core.RequestOptions): Core.APIPromise<PaymentRetrieveLineItemsResponse>;
}
export declare class PaymentListResponsesDefaultPageNumberPagination extends DefaultPageNumberPagination<PaymentListResponse> {
}
...
export type PaymentMethodTypes = 'credit' | 'debit' | 'upi_collect' | 'upi_intent' | 'apple_pay' | 'cashapp' | 'google_pay' | 'multibanco' | 'bancontact_card' | 'eps' | 'ideal' | 'przelewy24' | 'affirm' | 'klarna' | 'sepa' | 'ach' | 'amazon_pay' | 'afterpay_clearpay';
...
export declare namespace PaymentRetrieveLineItemsResponse {
    interface Item {
        amount: number;
        items_id: string;
