...
export declare class Subscriptions extends APIResource {
     ...
     */
    retrieveUsageHistory(subscriptionId: string, query?: SubscriptionRetrieveUsageHistoryParams, options?: Core.RequestOptions): Core.PagePromise<SubscriptionRetrieveUsageHistoryResponsesDefaultPageNumberPagination, SubscriptionRetrieveUsageHistoryResponse>;
...
export declare namespace SubscriptionRetrieveUsageHistoryResponse {
    interface Meter {
        /**
         * Meter identifier
         */
...
export declare namespace SubscriptionChargeParams {
    /**
     * Specify how customer balance is used for the payment
     */
    interface CustomerBalanceConfig {
        /**
