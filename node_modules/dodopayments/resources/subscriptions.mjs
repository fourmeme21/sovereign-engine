...
export class Subscriptions extends APIResource {
    ...
    retrieveUsageHistory(subscriptionId, query = {}, options) {
        ...
        return this._client.getAPIList(`/subscriptions/${subscriptionId}/usage-history`, SubscriptionRetrieveUsageHistoryResponsesDefaultPageNumberPagination, { query, ...options });
    }
}
