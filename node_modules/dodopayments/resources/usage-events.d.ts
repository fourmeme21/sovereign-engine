...
export declare class UsageEvents extends APIResource {
     ...
     */
    list(query?: UsageEventListParams, options?: Core.RequestOptions): Core.PagePromise<EventsDefaultPageNumberPagination, Event>;
     ...
     * ```
     */
    ingest(body: UsageEventIngestParams, options?: Core.RequestOptions): Core.APIPromise<UsageEventIngestResponse>;
}
