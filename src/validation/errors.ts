...
export type ValidationErrorCode =
  ...
  | "PRE_FLIGHT_STALE"        // assumed_state bayatlamış
  | "PRE_FLIGHT_ENTITY_INACTIVE" // Kayıt geçersiz
...
const ERROR_CATALOG: Record<ValidationErrorCode, Omit<ValidationError, "code" | "field" | "rule">> = {
  // Schema hataları
  MISSING_FIELD: {
...
export function makeError(
  ...
  overrides?: Partial<Pick<ValidationError, "field" | "rule" | "message" | "hint">>
): ValidationError {
 ...
 */
export function toLogEntry(error: ValidationError, decisionId?: string): Record<string, unknown> {
  return {
